...
- **Type**: Greenfield
- **Scope**: new
- **Stack**: TypeScript / Next.js (App Router) / Zustand / Amazon Bedrock SDK (Claude Sonnet 4.5) / PostgreSQL
...
- **AI Integration**: Amazon Bedrock SDK — Claude Sonnet 4.5 (server-side)
...
| AI Generator | New | Bedrock-powered (Claude Sonnet 4.5) slide generation pipeline |
...
- Integration Points: Amazon Bedrock API (Claude Sonnet 4.5), Google Slides API, Google Drive API, Unsplash API, PostgreSQL database, File storage (user uploads), Real-time sync (WebSocket/CRDT)
