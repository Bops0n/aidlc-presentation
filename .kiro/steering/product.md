...
## Key Features
- **AI Slide Generation**: สร้าง slide จาก text prompt ผ่าน Google Gemini พร้อม layout mapping อัตโนมัติ
...
- API keys (Gemini, Google) ต้องอยู่ server-side เท่านั้น
...
**Assumptions**:
- ผู้ใช้มี Google Cloud credentials สำหรับ Gemini และ Slides export
